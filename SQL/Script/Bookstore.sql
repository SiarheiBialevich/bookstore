...
INSERT INTO `bookstore`.`genres` (`id`, `name`) VALUES (3, 'novel');
...
INSERT INTO `bookstore`.`authors` (`id`, `name`, `lastname`, `d_birth`, `biography`) VALUES (2, 'Nick', 'Perumov', '21-11-1963', 'Popular modern Russian writer, Nick (Nikolai Zhukov) Perumov was born November 21, 1963. An engineer-physicist graduated from the Department of Biophysics, physics and mechanics faculty of the Leningrad Polytechnic Institute. He then about ten years he was engaged in molecular immunology, he worked at the Leningrad research Institute of highly pure biopreparations.');
INSERT INTO `bookstore`.`authors` (`id`, `name`, `lastname`, `d_birth`, `biography`) VALUES (3, 'Sergei', 'Lukyanenko', '11-04-1968', 'Sergei Lukyanenko — Russian science fiction writer. Born in Kazakhstan, profession — psychiatrist. The first book came out at the turn of 80-90 years. Starting with things that felt imitation Krapivin (of ours) and Heinlein (from overseas), moved fast enough to be creative in their own original style.');
...
INSERT INTO `bookstore`.`books_locations` (`id`, `books_id`, `locations_id`, `count`) VALUES (2, 1, 2, 100);
INSERT INTO `bookstore`.`books_locations` (`id`, `books_id`, `locations_id`, `count`) VALUES (3, 2, 3, 75);
